...
export default function Details(props) {
  return (
    <details>
      <summary className="max-w-350px w-full bg-details-button-gray focus:ring-inset-1 focus:ring-2 focus:ring-black active:bg-details-button-active-gray hover:bg-details-button-hover-gray rounded py-12px px-5px font-body text-sm text-center text-custom-blue-reportButton cursor-pointer border border-outset border-details-button-gray">
        {props.text}
      </summary>
