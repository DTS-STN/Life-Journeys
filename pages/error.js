...
export async function getServerSideProps() {
  ...
  const errorCode = res.ok ? 500 : res.statusCode;
...
export default function Page({ errorCode, stars }) {
  console.log("error code in the page is ", errorCode);
  if (errorCode) {
    return (
      <>
  ...
  return (
    <div className="bolder text-blue-700">
      Next stars: {stars}, errorcode = {errorCode}
    </div>
  );
}
